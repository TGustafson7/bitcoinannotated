...
deck: "The maximalist rhetorical move that separated bitcoin culture from everything else."
era: "2017 Run"
type: "Phrase"
date: 2017-01-01
blockHeightAtOrigin: 446032
...
sources:
  - url: "https://nakamotoinstitute.org/"
    label: "Satoshi Nakamoto Institute — the maximalist tradition document archive (founded 2013)"
    primary: true
  - url: "https://www.coindesk.com/markets/2018/06/13/wbd28-an-interview-with-pierre-rochard-on-bitcoin-maximalism/"
    label: "What Bitcoin Did Ep. 28 — Pierre Rochard on Bitcoin Maximalism (June 2018)"
  - url: "https://saifedean.com/thebitcoinstandard"
    label: "Saifedean Ammous, The Bitcoin Standard (2018) — the foundational maximalist text"
related: []
foundational: false
---
The phrase has no single coiner. It crystallized rather than originated. By approximately the beginning of 2017 — the year of the Block Size Wars, the year of the Bitcoin Cash fork, the year the broader cryptocurrency boom began to draw attention away from bitcoin specifically — a rhetorical move had become standard practice among a subset of bitcoiners. The move was a categorical separation. There was bitcoin. There was, separately, everything else. The everything-else category went by various names: altcoins, crypto, web3, blockchain, digital assets, the crypto industry. The point of the separation was not that the other category did not exist, but that lumping bitcoin into it was a category error.
