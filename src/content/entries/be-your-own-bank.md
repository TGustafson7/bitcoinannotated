...
deck: "The phrase, popularized by Andreas Antonopoulos in 2014, that named bitcoin's invitation rather than its warning."
era: "Dark Forest"
type: "Phrase"
date: 2014-01-01
sourcePlatform: "Conference circuit / Let's Talk Bitcoin podcast"
locked: true
foundational: false
...
sources:
  ...
  - url: "https://www.tapesearch.com/episode/ltb-be-your-own-bank-and-the-luxury-of-apathy/9HLdDT2Fo2JZwY3JqQoQhV"
    label: "Let's Talk Bitcoin: Be Your Own Bank and the Luxury of Apathy (June 7, 2020)"
...
The slogan persists despite the difficulty it describes, in part because the difficulty is the point. Bitcoin's original argument against the existing financial system was not that the system was inefficient but that the system had a single point of failure: the institutions through which trust had to be routed. To remove the institutions was to remove the failure point and to relocate it inside the user. The user, alone with their keys, is now the bank. There is no backup phone number to call, no fraud department. The freedom is total, and so is the responsibility.
