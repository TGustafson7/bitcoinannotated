...
The cultural utility of *hyperbitcoinization* is that it gave bitcoiners a single word for the thesis underneath the asset. The thesis can be argued with, ridiculed, or believed; what it cannot be is unsaid. Krawisz did not predict that bitcoin would replace the dollar. He wrote down the conditions under which such a replacement could be described as having happened, and gave the resulting event a name the bitcoin community has used ever since.
