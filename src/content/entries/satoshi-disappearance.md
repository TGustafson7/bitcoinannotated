---
title: "Satoshis Disappearance"
deck: "The protocol survived its creator. The creator went quiet on a Saturday afternoon."
era: "First Bull"
type: "Event"
date: 2011-04-23
...
sources:
  - url: "https://plan99.net/~mike/satoshi-emails/thread5.html"
    label: "Mike Hearn — archived email thread with Satoshi (April 23, 2011)"
    primary: true
  - url: "https://bitcointalk.org/index.php?topic=2013.msg26054#msg26054"
    label: "Satoshi — final BitcoinTalk post (December 12, 2010)"
---
...
The disappearance is load-bearing in a way the design alone could not be. A protocol with a known founder is a protocol that bears that founder's authority. Satoshi could have remained a public figure indefinitely; the system would have worked, but every dispute would have carried an implicit appeal to the creator. By disappearing, he removed himself as an authority and left only the code and the social consensus around it. The community has periodically searched — Newsweek thought it had found him in 2014, Craig Wright has claimed to be him, others have been speculated about — and the search has always returned empty. He is not findable because he stopped being findable. Whatever bitcoin becomes, it becomes without him, on purpose.

The closing line of the email is among the most-cited sentences Satoshi ever wrote. It carries no rhetorical weight; it is a working developer's casual farewell embedded in a technical reply. The community has spent fifteen years reading meaning into it that Satoshi may not have intended. That, too, is the artifact: a protocol that continues to operate on the strength of an aside.
